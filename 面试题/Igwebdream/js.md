...
### <span id="mySetInterVal"> 写一个 mySetInterVal(fn, a, b),每次间隔 a,a+b,a+2b,...,a+nb 的时间，然后写一个 myClear，停止上面的 mySetInterVal </span>
...
### 实现一个倒计时,setInterval 实现的话，如何消除时间误差
...
### 实现 Function 原型的 bind 方法，使得以下程序最后能输出“success”
